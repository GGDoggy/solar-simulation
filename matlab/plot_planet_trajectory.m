function plot_planet_trajectory(ax1, ax2, planet_name, planet_traj, start_time, end_time, scale, color)
    ...
    plot(ax1, rs(:,1), rs(:,2), 'DisplayName', planet_name, 'Color', color);
    plot(ax2, rs(:,1), rs(:,3), 'DisplayName', planet_name, 'Color', color);
